...
export function AdminCreatePostPage() {
  ...
  const handleFileChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    if (!isImage && !isVideo) {
      ...
      setStatus('error');
      setMessage('Можно выбрать только фото или видео.');
      return;
    }
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!user) {
      setStatus('error');
      setMessage('Чтобы создать пост, нужно войти в админский аккаунт.');
      return;
    }

    if (user.role !== 'ADMIN') {
      setStatus('error');
      setMessage('Создавать посты может только администратор.');
      return;
    }
        ...
        <ContentGrid>
          <FormCard onSubmit={handleSubmit}>
            ...
            <FieldGroup>
              ...
              <Hint>{description.trim().length}/1200 символов</Hint>
            </FieldGroup>
            ...
            <FieldGroup>
              ...
              <VisibilityGrid>
                ...
                >
                  ...
                  <small>Пост видят все пользователи</small>
                </span>
                </VisibilityButton>
                ...
                >
                  ...
                  <small>Пост видят только подписчики</small>
                </span>
                </VisibilityButton>
              </VisibilityGrid>
            </FieldGroup>
