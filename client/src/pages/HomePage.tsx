  ...
  if (isError) {
    return (
        <StateCard>
          ...
          <p>Проверьте подключение или попробуйте обновить список публикаций.</p>
      ...
      <Page>
        <Hero>
          <HeroContent>
            ...
            <Subtitle>
              Публичные посты доступны всем пользователям. Авторизуйтесь, чтобы
              лайкать, дизлайкать, комментировать и сохранять публикации в профиль.
            </Subtitle>
          </HeroContent>
        ...
        {filteredPosts.length ? (
            ...
            <EmptyCard>
              ...
              <h2>Публичных постов пока нет</h2>

              <p>
                Создайте пост в админке или примите пользовательскую заявку в
                обычную ленту, и публикации появятся здесь.
              </p>
            </EmptyCard>
        )}
      </Page>
